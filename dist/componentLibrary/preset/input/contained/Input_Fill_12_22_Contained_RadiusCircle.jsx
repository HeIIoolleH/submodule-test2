...
function Input_Fill_12_22_Contained_RadiusCircle(props) {
    const { className, ...rest } = props;
    return (<Input className={className + " Input_Fill_12_22_Contained_RadiusCircle"} inputType={inputType} widthOption={widthOption} paddingOption={paddingOption} radiusOption={radiusOption} {...rest}/>);
}

...
function Input_Fill_12_16_Contained_Radius60(props) {
    const { className, ...rest } = props;
    return (<Input className={className + " Input_Fill_12_16_Contained_Radius60"} inputType={inputType} widthOption={widthOption} paddingOption={paddingOption} {...rest}/>);
}

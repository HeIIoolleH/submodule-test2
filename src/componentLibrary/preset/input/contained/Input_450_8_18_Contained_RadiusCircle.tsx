...
export interface Input_450_8_18_Contained_RadiusCircle_Props extends React.InputHTMLAttributes<HTMLInputElement> {}
...
function Input_450_8_18_Contained_RadiusCircle(props: Input_450_8_18_Contained_RadiusCircle_Props) {
    const { className, ...rest } = props;
    return (
        <Input
            className={className + " Input_450_8_18_Contained_RadiusCircle"}
            inputType={inputType}

...
export interface Input_450_12_16_Contained_Radius60_Props extends React.InputHTMLAttributes<HTMLInputElement> {}

const inputType = InputDesignType.Contained;
const paddingOption = InputPaddingPresetOption.L;

function Input_450_12_16_Contained_Radius60(props: Input_450_12_16_Contained_Radius60_Props) {

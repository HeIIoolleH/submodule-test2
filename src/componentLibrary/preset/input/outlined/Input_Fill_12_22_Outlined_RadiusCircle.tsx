...
export interface Input_Fill_12_22_Outlined_RadiusCircle_Props extends React.InputHTMLAttributes<HTMLInputElement> {}
...
function Input_Fill_12_22_Outlined_RadiusCircle(props: Input_Fill_12_22_Outlined_RadiusCircle_Props) {
    const { className, ...rest } = props;
    return (
        <Input
            className={className + " Input_Fill_12_22_Outlined_RadiusCircle"}
            inputType={inputType}

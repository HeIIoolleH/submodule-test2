...
export interface Input_Fill_12_16_Outlined_Radius60_Props extends React.InputHTMLAttributes<HTMLInputElement> {}
...
function Input_Fill_12_16_Outlined_Radius60(props: Input_Fill_12_16_Outlined_Radius60_Props) {
    const { className, ...rest } = props;
    return (
        <Input
            className={className + " Input_Fill_12_16_Outlined_Radius60"}
            inputType={inputType}

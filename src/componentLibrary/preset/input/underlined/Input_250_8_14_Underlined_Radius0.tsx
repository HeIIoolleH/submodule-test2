...
export interface Input_250_8_14_Underlined_Radius0_Props extends React.InputHTMLAttributes<HTMLInputElement> {}

const inputType = InputDesignType.Underlined;
const paddingOption = InputPaddingPresetOption.M;

function Input_250_8_14_Underlined_Radius0(props: Input_250_8_14_Underlined_Radius0_Props) {

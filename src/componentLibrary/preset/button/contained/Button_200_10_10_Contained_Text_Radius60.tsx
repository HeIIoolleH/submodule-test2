...
export interface Button_200_10_10_Contained_Text_Radius60_Props extends DetailedHTMLProps<ButtonHTMLAttributes<HTMLButtonElement>, HTMLButtonElement> {}
...
function Button_200_10_10_Contained_Text_Radius60(props: Button_200_10_10_Contained_Text_Radius60_Props) {
    const { className, ...rest } = props;

    return (
        <Button
            className={className + " Button_200_10_10_Contained_Text_Radius60"}
            isUseFocus={false}
            pattern={pattern}

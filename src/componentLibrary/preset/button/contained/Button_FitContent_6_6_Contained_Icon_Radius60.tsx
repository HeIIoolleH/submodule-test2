...
export interface Button_FitContent_6_6_Contained_Icon_Radius60_Props extends DetailedHTMLProps<ButtonHTMLAttributes<HTMLButtonElement>, HTMLButtonElement> {}
...
function Button_FitContent_6_6_Contained_Icon_Radius60(props: Button_FitContent_6_6_Contained_Icon_Radius60_Props) {
    const { className, ...rest } = props;

    return (
        <Button
            className={className + " Button_FitContent_6_6_Contained_Icon_Radius60"}
            isUseFocus={false}
            pattern={pattern}

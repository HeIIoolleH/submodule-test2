...
export interface Button_240_10_10_Outlined_Text_Radius60_Props extends DetailedHTMLProps<ButtonHTMLAttributes<HTMLButtonElement>, HTMLButtonElement> {}
...
function Button_240_10_10_Outlined_Text_Radius60(props: Button_240_10_10_Outlined_Text_Radius60_Props) {
    const { className, ...rest } = props;

    return (
        <Button
            className={className + " Button_240_10_10_Outlined_Text_Radius60"}
            isUseFocus={false}
            pattern={pattern}

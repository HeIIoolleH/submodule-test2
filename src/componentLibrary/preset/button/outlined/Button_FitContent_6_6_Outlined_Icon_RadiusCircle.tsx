...
export interface Button_FitContent_6_6_Outlined_Icon_RadiusCircle_Props extends DetailedHTMLProps<ButtonHTMLAttributes<HTMLButtonElement>, HTMLButtonElement> {}
...
function Button_FitContent_6_6_Outlined_Icon_RadiusCircle(props: Button_FitContent_6_6_Outlined_Icon_RadiusCircle_Props) {
    const { className, ...rest } = props;

    return (
        <Button
            className={className + " Button_FitContent_6_6_Outlined_Icon_RadiusCircle"}
            isUseFocus={false}
            pattern={pattern}

...
export interface Button_FitContent_6_10_Outlined_Text_RadiusCircle_Props
...
function Button_FitContent_6_10_Outlined_Text_RadiusCircle(props: Button_FitContent_6_10_Outlined_Text_RadiusCircle_Props) {
    const { className, ...rest } = props;

    return (
        <Button
            className={className + " Button_FitContent_6_10_Outlined_Text_RadiusCircle"}
            isUseFocus={false}
            pattern={pattern}

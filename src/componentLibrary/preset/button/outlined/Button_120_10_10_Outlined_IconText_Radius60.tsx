...
export interface Button_120_10_10_Outlined_IconText_Radius60_Props extends DetailedHTMLProps<ButtonHTMLAttributes<HTMLButtonElement>, HTMLButtonElement> {}
...
function Button_120_10_10_Outlined_IconText_Radius60(props: Button_120_10_10_Outlined_IconText_Radius60_Props) {
    const { className, ...rest } = props;
    return (
        <Button
            className={className + " Button_120_10_10_Outlined_IconText_Radius60"}
            isUseFocus={false}
            pattern={pattern}

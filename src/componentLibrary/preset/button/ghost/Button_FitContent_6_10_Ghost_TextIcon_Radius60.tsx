...
export interface Button_FitContent_6_10_Ghost_TextIcon_Radius60_Props extends DetailedHTMLProps<ButtonHTMLAttributes<HTMLButtonElement>, HTMLButtonElement> {}
...
function Button_FitContent_6_10_Ghost_TextIcon_Radius60(props: Button_FitContent_6_10_Ghost_TextIcon_Radius60_Props) {
    const { className, ...rest } = props;

    return (
        <Button
            className={className + " Button_FitContent_6_10_Ghost_TextIcon_Radius60"}
            isUseFocus={false}
            pattern={pattern}
